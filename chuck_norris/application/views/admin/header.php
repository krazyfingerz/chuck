...
<head>
    ...
    <title>Chuck Norris System</title>
...
<body class="c-app">
    <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
        <div class="c-sidebar-brand d-md-down-none">
            <span class="c-sidebar-brand-full" style="font-size:20px;">Chuck Norris </span>
            <span class="c-sidebar-brand-minimized" style="font-size:20px;">Chuck Norris</span>
        </div>
        <ul class="c-sidebar-nav ps ps--active-y">
            <!-- <li class="c-sidebar-nav-title">Users</li> -->

            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link <?php if ($this->router->fetch_class() == 'User') {
                                                    echo 'c-active';
                                                } ?>" href="<?= site_url('User'); ?>">
